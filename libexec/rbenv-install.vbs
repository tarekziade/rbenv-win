...
listEnv = Array(_
    ...
    Array("2.6.9-i386"       ,"https://github.com/oneclick/rubyinstaller2/releases/download/RubyInstaller-2.6.9-1/","rubyinstaller-2.6.9-1-x86.7z" ,"bundled"),_
...
Sub installDevKit(cur)
    ...
    If cur(4) = "bundled" Then
        objws.Run """" & cur(1) & "\bin\ridk.cmd"" install 1", 1 , true
    Else
